    ...
    return {
        ...
        updateTranslation: function (translation) {
            ...
            for (var name in translation) {
                $.extend(parameters,{[name]:encodeURIComponent(translation[name])});
            }
        ...
        initializeParametersWithCsrf: function(parameters) {
            ...
            if(translationCfg.csrfToken ){
               $.extend(parameters,{_token:encodeURIComponent(translationCfg.csrfToken)});
    ...
    return {
        ...
        build: function (locales, labels) {
            this.columns = [
                ...
                {title: labels.domain, index: '_domain', type: 'text', class: 'form-control', edit: false, delete: false, filter: {'_domain': 'text'}, sortable: true, visible: true},
                {title: labels.key, index: '_key', type: 'text', class: 'form-control', edit: false, delete: true, filter: {'_key': 'text'}, sortable: true, visible: true},
                {title: labels.createdAt, index: '_createdAt', type: 'text', class: 'form-control date-picker', edit: false, delete: true, filter: false, sortable: true, visible: true}
            ];

            for (var key in locales) {
                var columnDef = {title: locales[key].toUpperCase(), index: locales[key], type: 'text', class: 'form-control', edit: true, delete: true, filter: {}, sortable: false, visible: true};
                columnDef['filter'][locales[key]] = 'text';
                this.columns.push(columnDef);
                var columnDef = {headerDisplay: 'none', index: locales[key] + '_confirmed', type: 'checkbox', class: '', edit: true, delete: true, filter: {}, sortable: false, visible: true};
                columnDef['filter'][locales[key] + '_confirmed'] = 'text';
                this.columns.push(columnDef);

                var columnDef = {headerDisplay: 'none', index: locales[key] + '_updatedAt', type: 'text', class: 'small', edit: false, delete: true, filter: false, sortable: true, visible: true};
                this.columns.push(columnDef);
            }

            var columnDef = {title: locales[key], index: 'confirmed', type: 'checkbox', class: '', edit: true, delete: true, filter: {}, sortable: false, visible: false};
            columnDef['filter']['confirmed'] = 'text';
            this.columns.push(columnDef);
