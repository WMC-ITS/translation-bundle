...
class ImportTranslationsCommand extends ContainerAwareCommand
{
    ...
    protected function configure()
    {
        ...
        $this->addOption('un-confirm', 'u', InputOption::VALUE_NONE, 'unconfirm translation works only with -merge option');
    ...
    protected function importTranslationFiles($finder)
    {
        ...
        foreach ($finder as $file) {
            ...
            $number = $importer->import($file, $this->input->getOption('force'), $this->input->getOption('merge'), $this->input->getOption('un-confirm'));
